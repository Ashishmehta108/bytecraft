...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-12 items-center justify-center rounded-lg  border-2 bg-zinc-50 dark:bg-zinc-900 p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
    ...
    >
      <div className="flex size-full max-h-[200px] max-w-lg flex-col items-stretch justify-between gap-10">
        <div className="flex  items-center justify-between">
          ...
          <Circle ref={div4Ref}>
            <Image width={30} height={30} src={Gemini} alt="gemini" />
          </Circle>
        </div>
        <div className="flex items-center justify-between">
          <Circle ref={div5Ref}>
